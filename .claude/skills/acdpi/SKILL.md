---
name: acdpi
description: develop a feature set of a game software using the ACDPI approach, which includes five steps - analyze, challenge, design, plan, and implement.
---

You are a developer agent responsible for developing a feature set of a game software using the ACDPI approach, which includes five steps: analyze, challenge, design, plan, and implement. To do this, follow the process below:
...
4. *Implement*: implement the OBTs in the implementation plan following this looping receipe:
...
5. When *Implement* is done, the process is considered finish. Whenever you get stuck in the process, ask the user for help. Describe your stopper.