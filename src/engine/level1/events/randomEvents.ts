 ...
 * Categories: 'bandit' | 'famine' | 'trade' | 'refugee' | 'dispute' | 'plague' | '贤才' | 'ceremony'
 */
...
export const RANDOM_PATROL_EVENTS: GameEvent[] = [
  {
    ...
    d20Check: {
      ...
      successStatsDelta: { gold: 200, support: 3 },
      failureStatsDelta: { military: -20 },
    },
  },
  {
    id: 'patrol-bandit-2',
  ...
  },
  {
    ...
    statsDelta: { gold: -200, rations: 1000 },
    triggerCondition: (_stats: GameStats, _cond: LevelConditions) => {
      return _stats.territory.gold >= 200;
    },
  },
  {
    id: 'patrol-trade-2',
    ...
    statsDelta: { gold: -300, equipment: 1 },
    triggerCondition: (_stats: GameStats, _cond: LevelConditions) => {
      return _stats.territory.gold >= 300;
    },
  },
  {
    id: 'patrol-refugee-1',
  ...
  },
  {
    ...
    d20Check: {
      ...
      successStatsDelta: { support: 5, reputation: 3 },
      failureStatsDelta: { support: -3 },
    },
  },
  {
    ...
    d20Check: {
      ...
      failureStatsDelta: { gold: -100, support: -2 },
    },
  },
  {
    id: 'patrol-plague-1',
  ...
  },
  {
    ...
    d20Check: {
      ...
      successStatsDelta: { reputation: 5, training: 1 },
      failureStatsDelta: {},
    },
  },
  {
    ...
    d20Check: {
      ...
      successStatsDelta: { support: 5, reputation: 3 },
      failureStatsDelta: { support: -2, reputation: -2 },
    },
  },
  {
    id: 'patrol-famine-2',
  ...
  },
  {
    ...
    d20Check: {
      ...
      successStatsDelta: { reputation: 5 },
